...
public class SOAPService_ServiceLocator extends org.apache.axis.client.Service implements com.niit.ws.service.SOAPService_Service {
    ...
    public com.niit.ws.service.SOAPService_PortType getSOAPServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.niit.ws.service.SOAPServicePortBindingStub _stub = new com.niit.ws.service.SOAPServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.niit.ws.service.SOAPService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.niit.ws.service.SOAPServicePortBindingStub _stub = new com.niit.ws.service.SOAPServicePortBindingStub(new java.net.URL(SOAPServicePort_address), this);
                _stub.setPortName(getSOAPServicePortWSDDServiceName());
                return _stub;
            }
        }
